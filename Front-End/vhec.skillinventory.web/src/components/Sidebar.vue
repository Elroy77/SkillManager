<template>
    <div class="sidebar">
        ...
        <div class="menu-items">
            ...
            <router-link to="/skill" active-class="active" tag="button" exact class="side-btn">
                <div class="link-container">
                    Skill
                </div>
            </router-link>
            <router-link to="/information" active-class="active" tag="button" exact class="side-btn">
                <div class="link-container">
                    Information
                </div>
            </router-link>
